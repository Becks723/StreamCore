...
type BotInfo struct {
	...
	// 展示名称
	BotName string `thrift:"bot_name,2,required" form:"bot_name,required" json:"bot_name,required" query:"bot_name,required"`
	// 头像
	AvatarURL string `thrift:"avatar_url,3,required" form:"avatar_url,required" json:"avatar_url,required" query:"avatar_url,required"`
	// 一句话描述
...
ReadStructEndError:
	return thrift.PrependError(fmt.Sprintf("%T read struct end error: ", p), err)
RequiredFieldNotSetError:
	return thrift.NewTProtocolExceptionWithType(thrift.INVALID_DATA, fmt.Errorf("required field %s is not set", fieldIDToName_BotInfo[fieldId]))
}
...
func (p *BotInfo) writeField5(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("system_prompt", thrift.STRING, 5); err != nil {
		goto WriteFieldBeginError
	}
...
type MCPToolInfo struct {
	ToolID string `thrift:"tool_id,1,required" form:"tool_id,required" json:"tool_id,required" query:"tool_id,required"`
	// 如 "query_course_schedule"
	ToolName string `thrift:"tool_name,2,required" form:"tool_name,required" json:"tool_name,required" query:"tool_name,required"`
	// 如 "查询指定学期的课程表"
	...
	// JSON Schema 字符串，定义参数
	InputSchema string `thrift:"input_schema,4,required" form:"input_schema,required" json:"input_schema,required" query:"input_schema,required"`
	// 所属 MCP Server 标识
	ServerName string `thrift:"server_name,5,required" form:"server_name,required" json:"server_name,required" query:"server_name,required"`
	// 所属 MCP Server ID
	ServerID int64 `thrift:"server_id,6,required" form:"server_id,required" json:"server_id,required" query:"server_id,required"`
}
...
func (p *MCPToolInfo) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_MCPToolInfo[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
ReadStructEndError:
	return thrift.PrependError(fmt.Sprintf("%T read struct end error: ", p), err)
RequiredFieldNotSetError:
	return thrift.NewTProtocolExceptionWithType(thrift.INVALID_DATA, fmt.Errorf("required field %s is not set", fieldIDToName_MCPToolInfo[fieldId]))
}

func (p *MCPToolInfo) ReadField1(iprot thrift.TProtocol) error {
...
func (p *MCPToolInfo) ReadField2(iprot thrift.TProtocol) error {
...
func (p *MCPToolInfo) ReadField3(iprot thrift.TProtocol) error {
...
func (p *MCPToolInfo) ReadField4(iprot thrift.TProtocol) error {
...
func (p *MCPToolInfo) ReadField5(iprot thrift.TProtocol) error {
...
func (p *MCPToolInfo) ReadField6(iprot thrift.TProtocol) error {
...
func (p *MCPToolInfo) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("MCPToolInfo"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField1(oprot); err != nil {
...
func (p *MCPToolInfo) writeField1(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("tool_id", thrift.STRING, 1); err != nil {
		goto WriteFieldBeginError
	}
	if err := oprot.WriteString(p.ToolID); err != nil {
		return err
	}
	if err = oprot.WriteFieldEnd(); err != nil {
		goto WriteFieldEndError
...
func (p *MCPToolInfo) writeField2(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("tool_name", thrift.STRING, 2); err != nil {
		goto WriteFieldBeginError
	}
...
func (p *MCPToolInfo) writeField3(oprot thrift.TProtocol) (err error) {
...
func (p *MCPToolInfo) writeField4(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("input_schema", thrift.STRING, 4); err != nil {
		goto WriteFieldBeginError
	}
...
func (p *MCPToolInfo) writeField5(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("server_name", thrift.STRING, 5); err != nil {
		goto WriteFieldBeginError
	}
...
func (p *MCPToolInfo) writeField6(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("server_id", thrift.I64, 6); err != nil {
		goto WriteFieldBeginError
	}
...
type MCPServerInfo struct {
	...
	ServerName string `thrift:"server_name,2,required" form:"server_name,required" json:"server_name,required" query:"server_name,required"`
	ServerURL  string `thrift:"server_url,3,required" form:"server_url,required" json:"server_url,required" query:"server_url,required"`
	// 同步间隔（秒）
	SyncIntervalSec int32  `thrift:"sync_interval_sec,4,required" form:"sync_interval_sec,required" json:"sync_interval_sec,required" query:"sync_interval_sec,required"`
	LastSyncedAt    string `thrift:"last_synced_at,5,required" form:"last_synced_at,required" json:"last_synced_at,required" query:"last_synced_at,required"`
	// 1: active, 0: disabled
...
func (p *MCPServerInfo) Read(iprot thrift.TProtocol) (err error) {
	...
	var issetSyncIntervalSec bool = false
	var issetLastSyncedAt bool = false
	...
	if !issetSyncIntervalSec {
		fieldId = 4
		goto RequiredFieldNotSetError
	}

	if !issetLastSyncedAt {
		fieldId = 5
		goto RequiredFieldNotSetError
	}
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_MCPServerInfo[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
ReadStructEndError:
	return thrift.PrependError(fmt.Sprintf("%T read struct end error: ", p), err)
RequiredFieldNotSetError:
	return thrift.NewTProtocolExceptionWithType(thrift.INVALID_DATA, fmt.Errorf("required field %s is not set", fieldIDToName_MCPServerInfo[fieldId]))
}

func (p *MCPServerInfo) ReadField1(iprot thrift.TProtocol) error {
...
func (p *MCPServerInfo) ReadField2(iprot thrift.TProtocol) error {
...
func (p *MCPServerInfo) ReadField3(iprot thrift.TProtocol) error {
...
func (p *MCPServerInfo) ReadField4(iprot thrift.TProtocol) error {
...
func (p *MCPServerInfo) ReadField5(iprot thrift.TProtocol) error {
	...
	p.LastSyncedAt = _field
	return nil
}
func (p *MCPServerInfo) ReadField6(iprot thrift.TProtocol) error {
...
func (p *MCPServerInfo) ReadField7(iprot thrift.TProtocol) error {
...
func (p *MCPServerInfo) ReadField8(iprot thrift.TProtocol) error {
...
func (p *MCPServerInfo) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("MCPServerInfo"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField1(oprot); err != nil {
...
func (p *MCPServerInfo) writeField1(oprot thrift.TProtocol) (err error) {
...
func (p *MCPServerInfo) writeField2(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("server_name", thrift.STRING, 2); err != nil {
		goto WriteFieldBeginError
	}
	if err := oprot.WriteString(p.ServerName); err != nil {
		return err
...
func (p *MCPServerInfo) writeField3(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("server_url", thrift.STRING, 3); err != nil {
		goto WriteFieldBeginError
	}
...
func (p *MCPServerInfo) writeField4(oprot thrift.TProtocol) (err error) {
...
func (p *MCPServerInfo) writeField5(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("last_synced_at", thrift.STRING, 5); err != nil {
		goto WriteFieldBeginError
	}
	if err := oprot.WriteString(p.LastSyncedAt); err != nil {
		return err
	}
	if err = oprot.WriteFieldEnd(); err != nil {
		goto WriteFieldEndError
...
func (p *MCPServerInfo) writeField6(oprot thrift.TProtocol) (err error) {
...
func (p *MCPServerInfo) writeField7(oprot thrift.TProtocol) (err error) {
...
func (p *MCPServerInfo) writeField8(oprot thrift.TProtocol) (err error) {
